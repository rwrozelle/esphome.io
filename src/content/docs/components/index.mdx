...
<ImgTable items={[
  ...
  ["LD6002B", "/components/sensor/ld6002b/", "ld6002b.png"],
...
<ImgTable items={[
  ...
  ["BLE Presence", "/components/binary_sensor/ble_presence/", "bluetooth.svg", "dark-invert"],
...
Used for defining images to draw on [displays](#display-components) or use with [LVGL](/components/lvgl/) widgets.

<ImgTable items={[
  ["Image Core", "/components/image/", "image-outline.svg", "dark-invert"],
