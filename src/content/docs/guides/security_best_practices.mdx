...
Security vulnerabilities are discovered and fixed regularly. Keep your ESPHome installation up to date by following the [installation instructions](/install/).
