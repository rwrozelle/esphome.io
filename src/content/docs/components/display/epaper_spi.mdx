...
### 6-color display example (reTerminal E1004)

The reTerminal E1004 features a 13.3" 6-color e-paper display (1200x1600, T133A01) that supports
black, white, red, green, blue, and yellow. Since it is an integrated board, only the model name
is needed. The display buffer requires approximately 960KB, so PSRAM is required.

Full refresh times are typically around 30 seconds.
